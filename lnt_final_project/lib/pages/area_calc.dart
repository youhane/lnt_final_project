        ...
        child: Column(
          ...
          children: [
            ...
            Row(
              ...
              children: [
                FloatingActionButton(onPressed: () {_changeShape("Square");}, child: const Icon(Icons.square)),
                FloatingActionButton(onPressed: () {_changeShape("Circle");}, child: const Icon(Icons.circle)),
                FloatingActionButton(onPressed: () {_changeShape("Triangle");}, child: const Icon(Icons.arrow_drop_up, size: 50.0,)),
              ],
            ),
            Text(
